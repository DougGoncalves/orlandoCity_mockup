<footer>
							...
							<div class="row row-cols">
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<ul class="list-unstyled list-socials">
										<li>
											<a href="https://www.facebook.com/OrlandoCitySC/" target="_blank"><i class="fa fa-facebook-f"></i></a>
										</li>
										<li>
											<a href="https://twitter.com/orlandocitysc" target="_blank"><i class="fa fa-twitter"></i></a>
										</li>
										<li>
											<a href="https://www.instagram.com/orlandocitysc" target="_blank"><i class="fa fa-instagram"></i></a>
										</li>
										<li>
											<a href="https://www.pinterest.com/orlandocitysc/" target="_blank"><i class="fa fa-pinterest"></i></a>
										</li>
										<li>
											<a href="#" class="visible-xs" id="page-up"><i class="fa fa-chevron-up"></i></a>
										</li>
									</ul>
			...
			<div class="row row-cinza-escuro">
				...
				<div class="container copyright-mobile">
					...
					<p class="pull-right text-roxo">Created Doug Goncalves</p>
